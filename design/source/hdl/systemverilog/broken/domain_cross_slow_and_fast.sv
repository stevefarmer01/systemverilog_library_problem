/**
 * @file    domain_cross_slow_and_fast.sv
 * @author  Steve Farmer
 * @date    07 July 2022
 * @brief   This has an inverted added into data_out below to show that it's impossible to pick which SV source file to use if they have the same module name
 * @note    
 *
 */
...
module domain_cross_slow_and_fast
  #(
  ...
  (
    input logic data_in_clk,    // This is always required even when not used in code below (FAST_TO_SLOW_DOMAIN_CROSSING = 0) because it is used for timing constraints in asscoiated file domain_cross_slow_and_fast.xdc
